...
<div style="display:none;" id="tmpl-external-media-links">
  <?php if ( count( $buttons ) ) : ?>
   <?php foreach ( $buttons as $button ) : ?>
       <a href="#" id="<?php echo $button['id']; ?>" <?php echo $button['attributes']; ?> <?php echo $button['attributes']; ?> class="button button-primary"><?php echo $button['label']; ?></a>
    <?php endforeach; ?>
...
<div class="external-media-buttons-wrapper">
  <button id="<?php echo $id; ?>" <?php echo $attributes; ?> class="button button-large external-media-button">
    <?php echo $label; ?>
  </button>
  <?php echo $html; ?>
</div>
