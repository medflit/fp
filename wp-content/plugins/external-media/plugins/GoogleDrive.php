 ...
 */
class GooglePickerAPI extends WPUploadMedia_Base {
  ...
  public function assets() {
    ...
    wp_register_script( get_class( $this ), plugins_url( '/plugins/js/GoogleDrive.js', WP_ExternalMedia_PluginName ), array( 'jquery', 'WP_ExternalMedia_admin_view_js', 'GooglePickerAPI_lib' ) );
