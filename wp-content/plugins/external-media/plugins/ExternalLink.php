 ...
 * External Link
 */
class ExternalLink extends WPUploadMedia_Base {
  ...
  public function html() {
    add_thickbox();
    return '<div id="em-external-link-modal" style="display:none;"><div class="em-form">
      <table class="form-table">
          <tr>
            <th scope="row"><label for="url">' . __('Import a file from URL') . '</label></th>
          <td>
        ...
        <tr>
          <th scope="row"></th>
          <td align="right">
            <input type="button" name="insert" id="el-insert" class="button button-primary button-hero" value="' . __('Import') . '">
            <input type="button" name="cancel" id="el-cancel" class="button button-hero" value="' . __('Cancel') . '">
          </td>
      </table>
    </div></div>';
  }
