...
Contributors: minnur
Donate link: https://donorbox.org/wordpressdev-io
Tags: Dropbox, Box, OneDrive, Google Drive, Instagram, Upload from remote, remote media, remote URL, remote image, remote file, external media, wp remote upload, external media upload, external image upload
...
Import files from thrid-party services (Dropbox, Box, OneDrive, Google Drive, Instagram and any external file).

== Description ==

Import files from or create external links from third-party services (Dropbox, Box, OneDrive, Google Drive, Instagram and any other external file from URL).
...
> Please consider donations so I can spend more time implementing new features and troubleshooting issues.

  - https://donorbox.org/wordpressdev-io
