...
class WP_ExternalMedia extends WP_ExternalUtility {
  ...
  public function page_rewrite_redirect() {
    ...
    if ( array_key_exists( 'external_media_plugin', $template ) && !empty( $template['external_media_plugin'] ) ) {
      ...
      require_once ( sprintf( "%s/templates/callback.php", WP_ExternalMedia_PATH ) );
      exit();
    }
  }
  ...
  public function admin_init() {
    ...
    // Admin assets.
    wp_register_style( 'WP_ExternalMedia_admin_css', plugins_url( '/css/admin.css', WP_ExternalMedia_PluginName ) );
    wp_register_script( 'WP_ExternalMedia_admin_js', plugins_url( '/js/external-media.js', WP_ExternalMedia_PluginName ), array( 'jquery' ) );
    wp_register_script( 'WP_ExternalMedia_admin_view_js', plugins_url( '/js/external-media-view.js', WP_ExternalMedia_PluginName ), array( 'jquery', 'media-views' ) );
    wp_enqueue_style( 'WP_ExternalMedia_admin_css' );
    wp_enqueue_script( 'WP_ExternalMedia_admin_js' );
    wp_enqueue_script( 'WP_ExternalMedia_admin_view_js' );
  }
